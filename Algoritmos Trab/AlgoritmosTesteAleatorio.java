...
class AlgoritmosTesteAleatorio {
	int i, randomInt;
	float randomFloat;
	double randomDouble;
	...
	@Test
	void numerosAleatoriosEmQuePVale1() {
		int []a = new int [10];
		...
		//preenche o vetor de forma aleatoria
		for(i = 0; i < 10; i++) {
		...
		System.out.println("TESTE PARA LISTA DE NUMEROS ALEATORIOS");
		System.out.println();
	...
	@Test
	void numerosAleatoriosEmQuePVale2() {
		int []a = new int [100];
	...
	@Test
	void numerosAleatoriosEmQuePVale3() {
		int []a = new int [1000];
	...
	@Test
	void numerosAleatoriosEmQuePVale4() {
		int []a = new int [10000];
	...
	@Test
	void numerosAleatoriosEmQuePVale5() {
	...
	@Test
	void numerosAleatoriosEmQuePVale6() {
