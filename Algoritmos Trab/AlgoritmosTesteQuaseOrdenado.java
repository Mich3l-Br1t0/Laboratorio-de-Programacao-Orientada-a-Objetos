...
public class AlgoritmosTesteQuaseOrdenado {
	int i, randomInt;
	float randomFloat;
	double randomDouble;
	...
	@Test
	void numerosQuaseOrdenadosEmQuePVale1() {
		int []a = new int [10];
		...
		//preenche o vetor de forma ordenada
		for(i = 0; i < 10; i++) {
			a[i] = i + randomInt;
			b[i] = (i + randomInt)*randomFloat;
			c[i] = (i+randomInt)*randomDouble;	
		}
		//adicionando numeros aleatorios em posicoes aleatorias
		//faz com que o vetor seja quase ordenado
		
		while(check.checaVetorInt(a) == true ||check.checaVetorFloat(b) == true || 
				check.checaVetorDouble(c) == true) {
			for(i = random.nextInt(9); i < 10; i+=random.nextInt(5)) {	
				a[i] = random.nextInt(100);
				b[i] = random.nextFloat()*10;
		...
		System.out.println("TESTE PARA LISTA DE NUMEROS QUASE ORDENADOS");
		System.out.println();
	...
	@Test
	void numerosQuaseOrdenadosEmQuePVale2() {
		int []a = new int [100];
		...
		if(check.checaVetorInt(a) == true || check.checaVetorFloat(b) == true || 
				check.checaVetorDouble(c) == true) {
	...
	@Test
	void numerosQuaseOrdenadosEmQuePVale3() {
		int []a = new int [1000];
	...
	@Test
	void numerosQuaseOrdenadosEmQuePVale4() {
		int []a = new int [10000];
	...
	@Test
	void numerosQuaseOrdenadosEmQuePVale5() {
	...
	@Test
	void numerosQuaseOrdenadosEmQuePVale6() {
